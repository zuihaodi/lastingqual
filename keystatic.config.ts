...
const siteSettings = singleton({
  ...
  schema: {
    ...
    themePreset: fields.select({
      label: "全站配色方案",
      options: [
        { label: "能源行业 - 工业深蓝橙（当前默认）", value: "industrial_navy" },
        { label: "能源行业 - SLB 强蓝科技", value: "slb_blue" },
        { label: "能源行业 - 中石油红金", value: "petrochina_red" },
        { label: "能源行业 - 安东深蓝红", value: "anton_blue_red" },
        { label: "能源行业 - 杰瑞橙青", value: "jereh_orange" },
        { label: "能源行业 - Halliburton 红黑", value: "halliburton_red" },
        { label: "能源行业 - Baker Hughes 绿青", value: "baker_green" },
        { label: "跨行业 - 金融信任蓝", value: "finance_blue" },
        { label: "跨行业 - 医疗洁净青", value: "health_teal" },
        { label: "跨行业 - 高端黑金", value: "premium_black_gold" },
        { label: "跨行业 - 科技紫蓝", value: "tech_indigo_cyan" },
        { label: "跨行业 - 新能源绿", value: "renewable_green" },
        { label: "跨行业 - 工业石墨黄", value: "industrial_graphite_yellow" },
      ],
      defaultValue: "industrial_navy",
      description: "选择后统一影响前台主色、强调色、按钮、页脚与重点区块。",
    }),
